...
function createBlackPage(width,height,onCloseCallBack){
  ...
  var bdiv= $("<div>").css({width:width, textAlign:"right", margin:"auto" });
  var img=$("<img src='res/closeBig.png' style='right:0;left:0;top:45px;margin:auto;position:absolute;z-index:9999;' title='close'>");
  bdiv.append(img);
  img.click( function(){
    bg.trigger("close");
  });
